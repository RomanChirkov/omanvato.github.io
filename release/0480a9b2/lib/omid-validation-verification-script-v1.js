...
var module$exports$omid$common$version = {ApiVersion:"1.0", Version:"1.3.23-iab3116"};
...
module$exports$omid$complianceVerificationScript$ComplianceVerificationClient.prototype.serialize_ = function(a, b) {
  ...
  for (d in a) {
    if (a.hasOwnProperty(d)) {
      ...
      "accessMode" === d && c.push(encodeURIComponent(b ? b + "[friendlyToTop]" : "friendlyToTop") + "=" + JSON.stringify((0,module$exports$omid$common$windowUtils.isTopWindowAccessible)((0,module$exports$omid$common$windowUtils.resolveGlobalContext)())));
    }
  }
  return c.join("&");
};
